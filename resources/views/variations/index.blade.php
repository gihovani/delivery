...
@section('breadcrumb')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">{{ __('Variations') }}</li>
    </ol>
@endsection
@section('content')
    <div class="container">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex">
                            <div class="mt-2">{{ __('Variations') }}</div>
                            <div class="ml-auto">
                                <a class="btn btn-success" id="new-entity" href="{{route('variations.create')}}">{{__('Add New')}}</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            var actionUrl = '{{ route('variations.index') }}';
